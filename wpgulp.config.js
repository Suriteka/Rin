...
module.exports = {
	...
	// Project options.
	projectURL: 'rin.suriteka', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// JS Vendor options.
	jsVendorSRC: './assets/js/custom/*.js', // Path to JS custom folder.
    ...
    watchJsVendor: './assets/js/custom/*.js', // Path to all custom JS files.
